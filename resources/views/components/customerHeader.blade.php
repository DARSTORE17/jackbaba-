<header id="main-header" class="d-flex align-items-center justify-content-between bg-white border-bottom shadow-sm px-3">
    ...
    <div class="dropdown">
        <a href="#" class="d-flex align-items-center text-decoration-none dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            @else
                @php $displayName = Auth::check() && Auth::user() ? Auth::user()->name : 'Customer'; @endphp
                <img src="https://ui-avatars.com/api/?name={{ urlencode($displayName) }}&background=10b981&color=fff&size=40"
                     alt="Profile Picture" class="profile-avatar" />
            @endif
